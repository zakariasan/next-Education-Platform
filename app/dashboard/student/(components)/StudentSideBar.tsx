...
import { LayoutDashboard, CircuitBoard, ClipboardCheck, ClipboardList, CalendarDays, NotebookText } from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { label: "Notes", icon: NotebookText, href: "/dashboard/student/notes" },
